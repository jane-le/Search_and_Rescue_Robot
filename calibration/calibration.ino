...
#include "IMU_20948.h"  // see the the LSM6DS_LIS3MDL file in this project to change board to LSM6DS33, LSM6DS3U, LSM6DSOX, etc
...
void setup(void) {
  ...
  cal.mag_hardiron[0] = 13.61;
  cal.mag_hardiron[1] = -22.93;
  cal.mag_hardiron[2] = -31.0;

  cal.mag_field = 50.06;
  
  cal.mag_softiron[0] = 0.998;
  cal.mag_softiron[1] = -0.002;
  cal.mag_softiron[2] = 0.017;
  cal.mag_softiron[3] = 0.002;
  cal.mag_softiron[4] = 1.071;
  cal.mag_softiron[5] = 0.045;
  cal.mag_softiron[6] = 0.017;
  cal.mag_softiron[7] = 0.045;
  cal.mag_softiron[8] = 0.937;
